...
namespace mkdb.Widgets.Button
{
	
	/// <summary>
	/// Tool Button wdbFrame
	/// </summary>
	public class wtbButton : ToolStripButton
	{
		protected int _img_index;
		
		public wtbButton(string name, string image_resource) : base()
		{
		...
		public Image GetEmbeddedImage()
		{
    		try
    		{
        		...
        		System.IO.Stream str = a.GetManifestResourceStream("mkdb.Widgets.Button.button.png");
        		if(str == null)
