...
namespace mkdb.Widgets.Label
{
	
	/// <summary>
	/// Tool Button wdbLabel
	/// </summary>
	public class wtbLabel : ToolStripButton
	{
		protected int _img_index;
		
		public wtbLabel(string name, string image_resource) : base()
		{
		...
		public Image GetEmbeddedImage()
		{
    		try
    		{
        		...
        		System.IO.Stream str = a.GetManifestResourceStream("mkdb.Widgets.Label.label.png");
        		if(str == null)
