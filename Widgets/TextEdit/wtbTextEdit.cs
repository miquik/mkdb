...
namespace mkdb.Widgets.TextEdit
{
	
	/// <summary>
	/// Tool Button wdbFrame
	/// </summary>
	public class wtbTextEdit : ToolStripButton
	{
		protected int _img_index;
		
		public wtbTextEdit(string name, string image_resource) : base()
		{
		...
		public Image GetEmbeddedImage()
		{
    		try
    		{
        		...
        		System.IO.Stream str = a.GetManifestResourceStream("mkdb.Widgets.TextEdit.textctrl.png");
        		if(str == null)
